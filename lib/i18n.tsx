...
const JA: Dict = {
  ...
  'support.inquiry.lead': 'お名前・メールアドレス・お問い合わせ内容をご入力のうえ送信してください。',
  'support.inquiry.name': 'お名前（任意）',
  'support.inquiry.namePlaceholder': '例：フラックス太郎',
  'support.inquiry.email': 'メールアドレス',
  ...
  'support.inquiry.error': 'メールアドレスとお問い合わせ内容をご入力ください。',
  'support.inquiry.sendError': '送信に失敗しました。しばらくしてからもう一度お試しください。',
  'support.inquiry.sentTitle': '送信しました',
  'support.inquiry.sentMessage': 'お問い合わせを受け付けました。ご返信までしばらくお待ちください。',
  'support.faq': 'よくある質問',
  'doc.thanks': 'CREDITS',
  'doc.terms': '利用規約',
...
const EN: Dict = {
  ...
  'support.inquiry.lead': 'Please enter your name, email address, and inquiry, then submit.',
  'support.inquiry.name': 'Name (optional)',
  'support.inquiry.namePlaceholder': 'e.g. Taro Flux',
  'support.inquiry.email': 'Email address',
  ...
  'support.inquiry.error': 'Please enter your email address and inquiry.',
  'support.inquiry.sendError': 'Failed to send. Please try again in a little while.',
  'support.inquiry.sentTitle': 'Sent',
  'support.inquiry.sentMessage': 'Your inquiry has been received. Please wait for our reply.',
  'support.faq': 'FAQ',
  'doc.thanks': 'CREDITS',
